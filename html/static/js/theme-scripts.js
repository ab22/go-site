...
function changeTraveloElementUI() {
    ...
    tjq('.datepicker-wrap input').datepicker({
        showOn: 'button',
        buttonImage: 'static/images/icon/blank.png',
        buttonText: '',
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Travelo - home" href="index.html"><img alt="" src="/static/images/logo.png"></a></h1>').insertBefore('.chaser .menu');
